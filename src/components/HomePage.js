...
function HomePage() {
  ...
  return (
    <div className="container text-center mt-4 hero">
      <h1>📚 Book Finder</h1>
      <p>Find your next favourite book — explore by category or search directly!</p>
      ...
      {bookTitle.trim() === "" ? (
        ...
        <p style={{ fontSize: "10px" }}>
          No results found for "{bookTitle}". Try a different title.
        </p>
      ) : (
            ...
            <div key={index} className="card m-3" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Author: {i.author_name?.join(", ") || "Unknown"}
                </p>
                <p className="card-text">
